		...
		<Col sm={10}>
			<Timeline lineColor={'#ddd'}>
				<TimelineItem key="001" dateText="8/2019 – Actualidad" style={{ color: '#e86971' }}>
					...
					<p>
						<DiAngularSimple className="dev-icon-md" />
						<DiJsBadge className="dev-icon-md" />
						<DiNodejsSmall className="dev-icon-md" />
						<DiDocker className="dev-icon-md" />
						<DiDatabase className="dev-icon-md" />
					</p>
				</TimelineItem>
				<TimelineItem key="002" dateText="1/2019 – 8/2019" dateInnerStyle={{ background: '#61b8ff' }}>
				...
				<TimelineItem key="003" dateText="3/2018 – 6/2018" dateInnerStyle={{ background: '#61b8ff' }}>
					<h3>Estudiante en prácticas</h3>
					<h4>SISTEMAS DE DATOS SL - Servicios y tecnologías de la información</h4>
					<p>
						<DiJava className="dev-icon-md" />
					</p>
				</TimelineItem>
